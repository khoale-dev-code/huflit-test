    ...
    <>
      <div className="bg-white border-2 border-slate-200 border-b-[6px] rounded-[24px] p-5 sm:p-7 shadow-sm font-sans">
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="flex flex-wrap items-center justify-between mb-2.5 gap-3">
              ...
              <div className="flex gap-2">
                <button onClick={handleQuickFill3} className="flex items-center gap-1.5 px-3 py-1.5 bg-[#FFFBEA] text-[#FF9600] border-2 border-[#FFD8A8] border-b-[3px] rounded-[10px] text-[11px] font-display font-black uppercase tracking-wider transition-all shadow-sm active:translate-y-[1px]"><Zap size={14} strokeWidth={3} /> 3 Lựa chọn</button>
                <button onClick={handleQuickFill4} className="flex items-center gap-1.5 px-3 py-1.5 bg-[#EAF6FE] text-[#1CB0F6] border-2 border-[#BAE3FB] border-b-[3px] rounded-[10px] text-[11px] font-display font-black uppercase tracking-wider transition-all shadow-sm active:translate-y-[1px]"><Zap size={14} strokeWidth={3} /> 4 Lựa chọn</button>
              </div>
            </div>
            ...
            <div className="mt-3">
              <button onClick={handleAddOption} className="text-[13px] font-body font-bold text-[#1CB0F6] flex items-center gap-1 hover:underline outline-none">
          ...
          <div>
            <label className="text-[12px] font-display font-black text-slate-400 uppercase tracking-widest block mb-2.5">Giải thích (tuỳ chọn)</label>
            <textarea value={q.explanation} onChange={e => setQ(p => ({ ...p, explanation: e.target.value }))} rows={2} className="w-full border-2 border-slate-200 rounded-[16px] px-5 py-4 text-[14px] font-body font-bold text-slate-800 focus:outline-none focus:border-[#1CB0F6] focus:ring-4 focus:ring-blue-500/10 bg-slate-50 focus:bg-white resize-y transition-all placeholder:text-slate-400" placeholder="Giải thích cho học viên..." />
          </div>
