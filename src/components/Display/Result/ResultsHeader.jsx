...
/* ══════════════════════════════════════════════════════════
   EXAM THEMES — Sử dụng tên màu chuẩn từ tailwind.config.js
══════════════════════════════════════════════════════════ */
const EXAM_THEMES = {
  toeic: {
    icon: Headphones,
...
const DecorativeSparkles = memo(({ color }) => {
  // fill-current sẽ lấy màu từ text-color
...
const ResultsHeader = memo(({ examCategory, title, subtitle }) => {
  ...
  const color           = theme.color; // 'blue', 'purple', 'green', 'yellow'
