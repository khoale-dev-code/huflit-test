...
import { ArrowLeft, Loader2, AlertTriangle, Calendar, PlayCircle, BookOpen, CheckCircle } from 'lucide-react';
...
// ✅ CLEAN CODE: Dùng Tailwind thay vì tạo thẻ <style> đè DOM.
// Đảm bảo CSS ở đây GIỐNG HỆT với EDITOR_STYLES trong GamifiedEditor của Admin
const CONTENT_STYLES = `
  ...
  /* Đảm bảo highlight và màu chữ inline hoạt động tốt */
...
const LessonDetail = () => {
  ...
  useEffect(() => {
    // Scroll lên đầu trang khi vào bài học
    window.scrollTo(0, 0);
    ...
    <div className="min-h-screen bg-[#F4F7FA] font-nunito selection:bg-[#1CB0F6] selection:text-white pb-24 relative">
      ...
      >
        ...
        <div className="bg-white rounded-[32px] p-6 sm:p-8 md:p-12 border-2 border-slate-200 border-b-[8px] shadow-sm">
           {/* Khu vực render HTML an toàn. Sử dụng biến CONTENT_STYLES đã quy định ở trên */}
           <div 
