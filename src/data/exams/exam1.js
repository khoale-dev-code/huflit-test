export const EXAM1_DATA = {
  ...
  description: "5 câu hỏi - 1 đoạn hội thoại dài giữa Mark và Sarah về chuyến đi. Nghe toàn bộ và chọn đáp án tốt nhất (A, B, C, D) dựa trên chi tiết. (Hỗ trợ luyện nghe hội thoại thực tế HUFLIT).",
  type: "listening",
  ...
  questions: [
    {
      id: 1,
      question: "She didn't buy anything because...",
      options: [
        "(A) The items weren't beautiful enough.",
        "(B) She found the prices too high.",
        "(C) She bought a lot of things because they were cheap.",
        "(D) She had no time to shop."
      ],
      correct: 1,
      explanation: "Sarah: 'I didn't buy anything because I found the prices too high.' (Sarah: 'Tôi không mua gì vì thấy giá quá cao.') - Luyện nghe chi tiết giá cả trong hội thoại du lịch."
    },
    {
      id: 2,
      question: "How long did she spend exploring Taiwan?",
      options: [
        "(A) About one month.",
        "(B) About one week.",
        "(C) About two weeks.",
      ...
      correct: 0,
      explanation: "Sarah: 'I spent about one month exploring the whole island.' (Sarah: 'Tôi dành khoảng một tháng khám phá toàn đảo.') - Luyện nghe thời gian và địa điểm du lịch."
    },
    {
      id: 3,
      question: "What did Sarah do at the night markets in Taipei?",
      options: [
        "(A) She bought lots of clothes and souvenirs.",
        "(B) She just window-shopped.",
        "(C) She ate street food.",
        "(D) She met local friends."
      ],
      correct: 1,
      explanation: "Sarah: 'I just window-shopped the whole time.' (Sarah: 'Tôi chỉ ngắm nghía suốt thời gian.') - Luyện nghe hoạt động thay thế khi không mua sắm."
    },
   {
      id: 4,
      question: "When do people recommend visiting Japan?",
      options: [
      ...
      correct: 2, // Option C
      explanation: "Sarah: 'I heard from a lot of people that you really need to visit in the spring to see the cherry blossoms at their peak.' (Sarah: 'Tôi nghe nhiều người nói rằng bạn thực sự cần đến vào mùa xuân để ngắm hoa anh đào ở đỉnh cao nhất.') - Luyện nghe thời điểm du lịch tốt nhất."
    },
    {
      id: 5,
      question: "How did Sarah find getting around in Tokyo?",
      options: [
        "(A) Very easy.",
        "(B) A little bit easy.",
        "(C) Quite difficult.",
        "(D) Impossible without a guide."
      ],
      correct: 1,
      explanation: "Sarah: 'I found it was a little bit easy to get around.' (Sarah: 'Tôi thấy nó hơi dễ di chuyển.') - Luyện nghe đánh giá mức độ dễ dàng trong du lịch thành phố lớn."
    }
  ]
},
part2: {
  title: "PART 2: Longer Conversation",
  description: "5 câu hỏi - Một đoạn hội thoại dài giữa ba người. Nghe toàn bộ và chọn đáp án tốt nhất (A, B, C, D).",
  type: "listening",
  ...
  questions: [
    { 
      ...
      correct: 1,
      explanation: "Mike, Sarah và John đều gọi orange juice, trong khi Older Woman gọi nước lọc. (Waiter: 'That's three orange juices.') - Luyện nghe đếm số lượng đơn hàng trong hội thoại nhà hàng."
    },
    { 
      id: 7, 
      question: "Why doesn't the woman want anything to eat?", 
      options: ["(A) Because she's not hungry.", "(B) Because she doesn't feel well.", "(C) Because she's on a diet.", "(D) Because the food is not good enough."], 
      correct: 0,
      explanation: "Sarah: 'I'm not hungry right now; I had a late lunch and I'm trying to eat lighter these days.' (Sarah: 'Tôi không đói lúc này; tôi ăn trưa muộn và đang cố ăn nhẹ hơn những ngày này.') - Luyện nghe lý do cá nhân trong quyết định ăn uống."
    },
    { 
      id: 8, 
      question: "What does Robertson do now?", 
      options: ["(A) He owns a restaurant.", "(B) He works in Orlando.", "(C) He works with young players.", "(D) He works in a restaurant."], 
      correct: 2,
      explanation: "Mike: 'He owns his own business still, but now he works with young players coaching soccer in Orlando.' (Mike: 'Ông ấy vẫn sở hữu doanh nghiệp riêng, nhưng giờ làm việc với các cầu thủ trẻ huấn luyện bóng đá ở Orlando.') - Luyện nghe thay đổi nghề nghiệp và chi tiết công việc."
    },
    { 
      id: 9, 
      question: "Who's coming to lunch?", 
      options: ["(A) The man's mother-in-law and his sister.", "(B) The man's mother and his sister-in-law.", "(C) The man's mother-in-law and her sister.", "(D) The man's sister-in-law and his sister."], 
      correct: 2,
      explanation: "Sarah: 'Mom and Aunt Lisa – your sister-in-law – are coming over for lunch tomorrow.' Older Woman: 'Yes, my sister and your aunt will join us.' (Sarah: 'Mẹ và dì Lisa – em dâu của anh – sẽ đến ăn trưa ngày mai.' Older Woman: 'Vâng, chị gái tôi và dì của cháu sẽ tham gia.') - Luyện nghe mối quan hệ gia đình trong hội thoại."
    },
    { 
      id: 10, 
      question: "What are they going to give their granddaughter for her birthday?", 
      options: ["(A) Money", "(B) Clothes", "(C) A hat", "(D) They can't decide."], 
      correct: 3,
      explanation: "Mike: 'We can't decide yet; let's think more.' (Mike: 'Chúng ta chưa quyết định được; hãy nghĩ thêm.') Sau khi thảo luận tiền, quần áo, mũ. - Luyện nghe quyết định chưa hoàn tất trong thảo luận quà tặng."
    }
  ]
},
part3: {
...
part5: {
  ...
  questions: [
    ...
    { 
      ...
      correct: 3,
      explanation: "Đáp án đúng là (D) 'regularly' vì đây là trạng từ (adverb) bổ nghĩa cho động từ 'learning' (hành động). Kiến thức ngữ pháp: Sử dụng trạng từ tần suất 'regularly' (thường xuyên) để bổ nghĩa động từ, thay vì tính từ (A), danh từ (B), hoặc động từ (C)."
    },
    { 
      id: 26, 
    ...
    { 
      ...
      correct: 0,
      explanation: "Đáp án đúng là (A) 'postened' vì đây là dạng quá khứ phân từ trong thì hiện tại hoàn thành thụ động (has been + V3). Kiến thức ngữ pháp: Cấu trúc bị động 'has been postponed' để diễn tả sự kiện bị hoãn; không dùng V-ing (B), nguyên thể (C), hoặc ngôi thứ ba (D)."
    },
    { 
      id: 30, 
...
342 Maymill Road, Fort Worth, TX 70609`,
  ...
  questions: [
    ...
    { 
      ...
      options: [
        "(A) A voice sample recording", 
        "(B) A phone call from a representative", 
        "(C) A written script", 
        "(D) A completed voicemail greeting"
      ], 
      correct: 1,
    ...
    { 
      ...
      options: [
        ...
        "(B) A data-processing and transcription business", 
        "(C) A voice acting agency", 
        "(D) A language school"
      ], 
      correct: 1,
    ...
    { 
      ...
      options: [
        "(A) On-hold messages with pleasant music", 
        "(B) A bilingual voicemail greeting", 
        "(C) Multiple voice actor samples", 
    ...
    { 
      ...
      options: [
        "(A) Between 10:00 A.M. and 5:00 P.M.", 
        "(B) Between 9:00 A.M. and 3:00 P.M.", 
...
Mr. Bach (20:15): Landed safely. See you soon!`,
  questions: [
    { 
      ...
      options: ["(A) He has been to Kansai more than once.", "(B) He currently works in Beijing.", "(C) He is on a business trip.", "(D) He works for Fly Right Airlines."], 
      correct: 2,
    ...
    { 
      ...
      options: ["(A) He has confirmed the arrival time of a flight.", "(B) He is certain he will be able to find a parking place.", "(C) He agrees to wait at the door near the customs area.", "(D) He knows Mr. Bach must pass through customs."], 
      correct: 2,
    ...
    { 
      ...
      options: ["(A) There was bad weather in Kansai.", "(B) He missed his connection in Beijing.", "(C) The airline changed the departure time.", "(D) He forgot to check in early."], 
      correct: 0,
      explanation: "Đáp án đúng là (A) vì 'Bad weather caused the delay' (thời tiết xấu gây chậm trễ). Kiến thức đọc hiểu: Trích dẫn trực tiếp lý do từ tin nhắn của Mr. Bach; lưu ý địa điểm chậm trễ là Beijing nhưng nguyên nhân là thời tiết (có thể ảnh hưởng đến Kansai)."
    },
    { 
      id: 54, 
      question: "What time is Mr. Bach's new flight expected to arrive?", 
      options: ["(A) 11:59", "(B) 12:06", "(C) 18:00", "(D) 20:15"], 
      correct: 1,
    ...
    { 
      ...
      options: ["(A) Drive him to the hotel", "(B) Pick him up at the airport", "(C) Change his flight booking", "(D) Help carry his luggage"], 
      correct: 1,
    ...
    { 
      ...
      options: ["(A) They are colleagues attending the same meeting.", "(B) They are family members traveling together.", "(C) They both work for Fly Right Airlines.", "(D) They have never met before."], 
      correct: 0,
    ...
    { 
      ...
      options: ["(A) To apologize for missing the meeting", "(B) To confirm he will not be late", "(C) To ask about the meeting location", "(D) To cancel his attendance"], 
      correct: 1,
    ...
    { 
      ...
      options: ["(A) He plans to check the airline's schedule.", "(B) He will change the meeting time.", "(C) He needs to contact the travel agent.", "(D) He will book another ticket for Mr. Bach."], 
      correct: 0,
    ...
    { 
      ...
      options: ["(A) He expects heavy traffic or limited parking.", "(B) He plans to take public transportation.", "(C) He works at the airport.", "(D) He has never been to Kansai Airport before."], 
      correct: 0,
    ...
    { 
      ...
      options: ["(A) Thanks for the help", "(B) Regret about missing the meeting", "(C) Frustration with the airline", "(D) Request for flight confirmation"], 
      correct: 0,
